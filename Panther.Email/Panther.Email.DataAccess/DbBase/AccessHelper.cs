...
namespace Panther.Email.DataAccess.DbBase
{
    ...
    {
        //数据库连接字符串
        public static readonly string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data source=" + AppDomain.CurrentDomain.BaseDirectory + "DB\\EmailManager.mdb" + "; User Id=admin; Password=;";
